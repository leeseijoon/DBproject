...
<div class="row">
  <div class="col-md-6">My current ETH : <span id="myeth">a</span>
  </div>
...
<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
    ...
    <form name="buysell" method="post">
     	...
     	<fieldset>		
				<h2 id="titletext">BUY / SELL ETH</h2>
				<input type="hidden" name = "c_idx" id="c_idx" value="2" />
				<div class="form-group">
                   Amount(ETH) <input type="number" min = 0 step = "0.000001" name="e_quantity" id="AmountBTC1" class="form-control input-lg">
				</div>
				<div class="form-group">
